...
<body>
  ...
  <div class="disp-flex flex-justify-space">
    <div class="img1">
      <img src="{{ asset('assets/logo.jpg') }}" alt="Logo" style="width: 200px; height: auto;" />
    </div>
    <div>about</div>
  </div>
  ...
  <div class="disp-flex flex-justify-space">
    <div>
      Portfolio
      <h1 class="title">I am Shuvo</h1>
      <p id="test">Daffodil International University</p>
    </div>
    <div>My projects</div>
  </div>
</section>
